...
public class StringInterviewSolutions {
    ...
    // 3 Join strings
    public static String joinStrings(String[] arr, String delim) {
    ...
    public static String removeCharacter(String s, char c) {
        ...
        while(i < sb.length()){
            if(sb.charAt(i)==c) sb.deleteCharAt(i);
            else i++;
        }
        return sb.toString();
    }
    ...
    public static String insertSpaceAfterNChars(String s, int n) {
        ...
        for(int i=0;i<s.length();i++){
            ...
            if((i+1)%n==0 && i<s.length()-1) sb.append(" ");
        }
        return sb.toString();
    }
}